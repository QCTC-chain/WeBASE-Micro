...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.webank";
    private static final String ARTIFACT_ID = "webase";
    private static final String PACKAGE_NAME = "com.webank";
    private static final String TITLE = "WeBASE-Micro";

    private static final String AUTHOR = "QCTC";
    private static final String CLOUD_DB = "webase-cloud";
    private static final String CONFIG_DB = "webase-config";
    private static final String JOB_DB = "webase-job";
    private static final String SEATA_DB = "webase-seata";

    private static final String VERSION_1 = ">1.0.0";
    private static final String VERSION_2 = ":1.0.0";
...
//        String titleNew = "土豆管理系统";
        ...
        String authorNew = "QCTC";
        String cloudDBNew = "webase-cloud";
        String configDBNew = "webase-config";
        String jobDBNew = "webase-job";
        String seataDBNew = "webase-seata";
        String version1New = ">1.0.0";
        String version2New = ":1.0.0";

        String groupIdNew = "com.webank";
        String artifactIdNew = "webase";
        String packageNameNew = "com.webank";
        String titleNew = "WeBASE-Micro";
//        String projectBaseDirNew = projectBaseDir + "-new"; // 一键改名后，“新”项目所在的目录
        String projectBaseDirNew = "/Users/zhangyang/Documents/项目相关/清大科越/BAAS/project/open/WeBASE-Micro-New"; // 一键改名后，“新”项目所在的目录
        ...
        files.forEach(file -> {
            ...
            if (WHITE_FILE_TYPES.contains(fileType)) {
                copyFile(file, projectBaseDir, projectBaseDirNew, packageNameNew, artifactIdNew, cloudDBNew, configDBNew, jobDBNew, seataDBNew);
                return;
            }
            // 如果非白名单的文件类型，重写内容，在生成文件
            String content = replaceFileContent(file, groupIdNew, artifactIdNew, packageNameNew, titleNew, authorNew,
                cloudDBNew, configDBNew, jobDBNew, seataDBNew, version1New, version2New);
            writeFile(file, content, projectBaseDir, projectBaseDirNew, packageNameNew, artifactIdNew, cloudDBNew, configDBNew, jobDBNew, seataDBNew);
        });
    ...
    private static String replaceFileContent(File file, String groupIdNew,
                                             ...
                                             String titleNew, String authorNew,
                                             String cloudDBNew, String configDBNew,
                                             String jobDBNew, String seataDBNew,
                                             String version1New, String version2New) {
        ...
        return content.replaceAll(GROUP_ID, groupIdNew)
                ...
                .replaceAll(CLOUD_DB, cloudDBNew)
                .replaceAll(CONFIG_DB, configDBNew)
                .replaceAll(JOB_DB, jobDBNew)
                .replaceAll(SEATA_DB, seataDBNew)
                .replaceAll(ARTIFACT_ID, artifactIdNew) // 必须放在最后替换，因为 ARTIFACT_ID 太短！
                .replaceAll(StrUtil.upperFirst(ARTIFACT_ID), StrUtil.upperFirst(artifactIdNew))
                .replaceAll(TITLE, titleNew)
                .replaceAll(AUTHOR, authorNew)
                .replaceAll(VERSION_1, version1New)
                .replaceAll(VERSION_2, version2New);
    }
    ...
    private static void writeFile(File file, String fileContent, String projectBaseDir,
                                  ...
                                  String cloudDBNew, String configDBNew,
                                  String jobDBNew, String seataDBNew) {
        String newPath = buildNewFilePath(file, projectBaseDir, projectBaseDirNew, packageNameNew, artifactIdNew, cloudDBNew, configDBNew, jobDBNew, seataDBNew);
