...
import com.webank.common.core.utils.TreeBuildUtils;
import com.webank.common.satoken.utils.LoginHelper;
import com.webank.system.api.domain.SysRole;
import com.webank.system.domain.SysMenu;
import com.webank.system.domain.SysRoleMenu;
import com.webank.system.domain.vo.MetaVo;
import com.webank.system.domain.vo.RouterVo;
import com.webank.system.mapper.SysMenuMapper;
import com.webank.system.mapper.SysRoleMapper;
import com.webank.system.mapper.SysRoleMenuMapper;
import com.webank.system.service.ISysMenuService;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    public String getRouteName(SysMenu menu) {
        String routerName = StringUtils.capitalize(menu.getPath()) + menu.getMenuId();
        // 非外链并且是一级目录（类型为目录）
        if (isMenuFrame(menu)) {
