...
import com.webank.common.core.enums.UserStatus;
...
import com.webank.system.mapper.SysUserMapper;
import com.webank.system.service.ISysConfigService;
import com.webank.system.service.ISysPermissionService;
import com.webank.system.service.ISysUserService;
...
public class RemoteUserServiceImpl implements RemoteUserService {
    ...
    public boolean hasPermission(String token, String permission) {
        ...
        List<String> list = new ArrayList<>(loginUser.getMenuPermission());
        return (Boolean) SaStrategy.instance.hasElement.apply(list, permission);
    }
